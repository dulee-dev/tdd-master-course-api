...
import { v4 } from 'uuid';
const router = Router();
const convertContentToContentView = (content, user) => {
    return Object.assign(Object.assign({}, omit(content, ['authorId'])), { author: user });
};
/**
 * @swagger
 * /contents/count:
...
router.patch('/contents/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const body = req.body;
    const updated = Object.assign(Object.assign({}, found), body);
    const idx = contentTable.findIndex((c) => c.id === id && c.authorId === user.id);
    if (idx !== -1) {
